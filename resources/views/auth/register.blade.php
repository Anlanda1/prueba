                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('puesto') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="puesto" type="puesto" class="form-control" name="puesto" value="{{ old('puesto') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('sueldo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sueldo" type="sueldo" class="form-control" name="sueldo" value="{{ old('sueldo') }}" required>
